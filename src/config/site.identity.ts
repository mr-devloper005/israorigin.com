export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'israorigin',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Israorigin',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'israorigin.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://israorigin.com',
