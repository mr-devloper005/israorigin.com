...
export default async function HomePage() {
  ...
  return (
    <EditableSiteShell>
      ...
      <div className="mx-auto w-full max-w-[var(--editable-container)] px-4 pt-10 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto w-full max-w-[var(--editable-container)] px-4 pb-4 pt-10 sm:px-6 lg:px-8">
